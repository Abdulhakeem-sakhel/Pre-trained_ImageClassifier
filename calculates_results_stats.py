...
def calculates_results_stats(results_dic: dict):
    ...
    pct_matched_labels = n_matched_lables / n_images * 100.0
    ...
    result_stats_dic['pct_matched_lables'] = pct_matched_labels
